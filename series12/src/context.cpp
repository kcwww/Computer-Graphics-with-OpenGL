...
void Context::Render()
{
    ...
    auto modelTransform =
        ...
        glm::scale(glm::mat4(1.0), glm::vec3(10.0f, 1.0f, 10.0f));
    ...
    modelTransform =
        glm::translate(glm::mat4(1.0), glm::vec3(-1.0f, 0.75f, -4.0f)) *
        glm::rotate(glm::mat4(1.0), glm::radians(30.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
